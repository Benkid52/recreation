    ...
    public String enter(HttpServletRequest request, User user) {
        ...
        if(isWorse) {
            ...
            if(userMsg.getPassword().equals(MD5.getMD5(user.getPassword()))) {
                if(json.getString("usertype").equals("2")) return "StudentSuccess";
                else {
                    if(!userMsg.isAdmin()) return "TeacherSuccess";
                    else return "AdminSuccess";
                }
            }
